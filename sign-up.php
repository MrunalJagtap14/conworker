        ...
        <div class="row latest-job margin-top-50 margin-bottom-20">
          ...
          <div class="col-md-6 latest-job ">
            <div class="small-box bg-yellow padding-5">
              <div class="inner">
                <h3 class="text-center">Supervisior Registration</h3>
              </div>
              <a href="register-supervisiors.php" class="small-box-footer">
          ...
          <div class="col-md-6 latest-job ">
            <div class="small-box bg-red padding-5">
              <div class="inner">
                <h3 class="text-center">Builder Registration</h3>
              </div>
              <a href="register-builder.php" class="small-box-footer">
                Register <i class="fa fa-arrow-circle-right"></i>
              </a>
            </div>
          </div>
