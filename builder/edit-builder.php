      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="edit-builder.php"><i class="fa fa-tv"></i> My Site</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            <h2><i>My Site</i></h2>
            <p>In this section you can change your Site details</p>
            <div class="row">
              <form action="update-builder.php" method="post" enctype="multipart/form-data">
                <?php
                $sql = "SELECT * FROM builder WHERE id_company='$_SESSION[id_company]'";
                ...
                <div class="col-md-6 latest-job ">
                  ...
                  <div class="form-group">
                    <button type="submit" class="btn btn-flat btn-success">Update Site Profile</button>
                  </div>
                </div>
                <div class="col-md-6 latest-job ">
                  <div class="form-group">
