...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Supervisior Login</p>
    ...
    <?php 
    //If supervisior have successfully registered then show them this success message
    ...
    ?>   
    <?php 
    //If supervisior Failed To log in then show error message.
