    ...
    <section class="content-header">
      <div class="container">
        <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
          ...
          <form method="post" id="registerCandidates" action="addsupervisior.php" enctype="multipart/form-data">
            <div class="col-md-6 latest-job ">
              ...
              <?php 
              //If supervisior already registered with this email then show error message.
