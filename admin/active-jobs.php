            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="active-jobs.php"><i class="fa fa-briefcase"></i> Active Site Jobs</a></li>
              ...
              <div class="col-md-12">
                <div class="box-body table-responsive no-padding">
                  <table id="example2" class="table table-hover">
                    ...
                    <tbody>
                      <?php
                      $sql = "SELECT job_post.*, builder.companyname FROM job_post INNER JOIN builder ON job_post.id_company=builder.id_company";
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
              ...
              <p>24/04/2017</p>
              <br>              
              <h3><b>Builder Name</b></h3>
              <p>XYX Private Limited</p>
              <br>
              <h3><b>builder Email</b></h3>
              <p>test@test.com</p>
              <br>
              <h3><b>Location</b></h3>
              <p>India</p>
