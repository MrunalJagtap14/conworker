            ...
            <div class="row">
              <div class="col-md-6">
                <div class="info-box bg-c-yellow">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text">Active Builders Registered</span>
                    <?php
              ...
              <div class="col-md-6">
                <div class="info-box bg-c-yellow">
                  <span class="info-box-icon bg-red"><i class="ion ion-briefcase"></i></span>
                  <div class="info-box-content">
                    <span class="info-box-text">Pending Builders Approval</span>
                    <?php
                      $sql = "SELECT * FROM builder WHERE active='2'";
                      $result = $conn->query($sql);
                      if($result->num_rows > 0) {
                        $totalno = $result->num_rows;
                      } else {
              ...
              <div class="col-md-6">
                <div class="info-box bg-c-yellow">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text">Registered Supervisiors</span>
                    <?php
              ...
              <div class="col-md-6">
                <div class="info-box bg-c-yellow">
                  <span class="info-box-icon bg-green"><i class="ion ion-person-stalker"></i></span>
                  <div class="info-box-content">
                    <span class="info-box-text">Pending Supervisiors Confirmation</span>
                    <?php
                      $sql = "SELECT * FROM supervisior WHERE active='0'";
                      $result = $conn->query($sql);
                      if($result->num_rows > 0) {
                        $totalno = $result->num_rows;
                      } else {
              ...
              <div class="col-md-6">
                <div class="info-box bg-c-yellow">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text">Total Site Job Posts</span>
                    <?php
