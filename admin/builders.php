            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="builders.php"><i class="fa fa-building"></i> Builders</a></li>
                      ...
                      <tr>
                        ...
                        <?php
                          if($row['active'] == '1') {
                            ...
                            ?>
                            <a href="reject-builder.php?id=<?php echo $row['id_company']; ?>">Reject</a> <a href="approve-builder.php?id=<?php echo $row['id_company']; ?>">Approve</a>
                            <?php
                          } else if ($row['active'] == '3') {
                            ?>
                              <a href="approve-builder.php?id=<?php echo $row['id_company']; ?>">Reactivate</a>
                            <?php
                        ...
                        <td><a href="delete-builder.php?id=<?php echo $row['id_company']; ?>">Delete</a></td>
                      </tr>  
                     <?php
                        }
                      }
