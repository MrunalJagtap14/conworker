...
<div class="login-box">
  <div class="login-logo">
    <a href="index.php"><b>BuildConnect</b> Site</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Builder Login</p>

    <form method="post" action="checkbuilderlogin.php">
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
        <?php 
              //If builder have successfully registered then show them this success message
              ...
              ?>   
              <?php 
              //If builder Failed To log in then show error message.
