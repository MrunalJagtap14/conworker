      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  <li class="active"><a href="edit-profile.php"><i class="fa fa-supervisior"></i> Edit Profile</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <?php
            //Sql to get logged in supervisior details.
            $sql = "SELECT * FROM supervisior WHERE id_user='$_SESSION[id_user]'";
            $result = $conn->query($sql);

            //If supervisior exists then show his details.
            ...
            ?>
              <div class="row">
                ...
                <div class="col-md-6 latest-job ">
                  ...
                  <div class="form-group">
                    <label>Upload/Change Labour List</label>
