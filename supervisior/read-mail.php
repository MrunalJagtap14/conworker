...
if($result->num_rows >  0 ){
  ...
  if($row['fromuser'] == "builder") {
    $sql1 = "SELECT * FROM builder WHERE id_company='$row[id_fromuser]'";
    $result1 = $conn->query($sql1);
    if($result1->num_rows >  0 ){
      $rowCompany = $result1->fetch_assoc();
    }
    $sql2 = "SELECT * FROM supervisior WHERE id_user='$row[id_touser]'";
    $result2 = $conn->query($sql2);
    if($result2->num_rows >  0 ){
      $rowUser = $result2->fetch_assoc();
    }
  } else {
    $sql1 = "SELECT * FROM builder WHERE id_company='$row[id_touser]'";
    $result1 = $conn->query($sql1);
    if($result1->num_rows >  0 ){
      $rowCompany = $result1->fetch_assoc();
    }
    $sql2 = "SELECT * FROM supervisior WHERE id_user='$row[id_fromuser]'";
    $result2 = $conn->query($sql2);
    if($result2->num_rows >  0 ){
      $rowUser = $result2->fetch_assoc();
    }
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  <li><a href="edit-profile.php"><i class="fa fa-supervisior"></i> Edit Profile</a></li>
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body no-padding">
                    <div class="mailbox-read-info">
                      ...
                      <h5>From: <?php if($row['fromuser'] == "builder") { echo $rowCompany['companyname']; } else { echo $rowUser['firstname']; } ?>
                ...
                if($resultReply->num_rows > 0) {
                  ...
                  <div class="box box-primary">
                    <div class="box-body no-padding">
                      <div class="mailbox-read-info">
                        <h3>Reply Message</h3>
                        <h5>From: <?php if($rowReply['usertype'] == "builder") { echo $rowCompany['companyname']; } else { echo $rowUser['firstname']; } ?>
